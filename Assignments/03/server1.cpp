...
const uint16_t DefaultPort = 8114; // Update this variable with your assigned port value
...
int main(int argc, char* argv[]) {
	...
	//here we can initialize the containers
    ...
    while (connection) {
		...
		std::future<HTTPResponse> responseFuture = std::async([&session]() -> HTTPResponse {
